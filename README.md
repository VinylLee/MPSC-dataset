...
This is the v0.1 version of the repository. The codebase is
still in an unorganized state. We have added a few test scripts 
and other auxiliary files to facilitate initial documentation. 
After the paper is accepted, we will take the time to clean up, 
organize, and document the code, then re-upload the repository as
a polished release. 
...
| Command | Purpose |
| --- | --- |
| `list-mrs` | List all 38 MR from the specification catalog. |
